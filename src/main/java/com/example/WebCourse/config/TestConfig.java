...
import com.example.WebCourse.entities.Payment;
...
import com.example.WebCourse.repositories.OrderItemRepository;
import com.example.WebCourse.repositories.OrderRepository;
import com.example.WebCourse.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Product p5 = new Product(null,"Rails for dummies","Cras fringilla convalles sem vel faucibus",100.99,"");
